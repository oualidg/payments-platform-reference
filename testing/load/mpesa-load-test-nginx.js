 ...
 *
 * Target:
 *   - Confirmation ingest: http://192.168.1.168 via Nginx (100r/s safety limit applies)
...
const GATEWAY_URL     = 'http://192.168.1.168';       // Via Nginx -- rate limiting applies
...
export default function (data) {
  ...
  const res = http.post(
    ...
    payload,
    {
      headers: { 'Content-Type': 'application/json', 'Host': 'mpesa.oualidg.dev' },
    }
  );
